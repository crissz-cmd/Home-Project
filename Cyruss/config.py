...
# INSTRUMEN & TIMEFRAME
# ============================================================
SYMBOLS = ["BTCUSDi"]        # sesuaikan kalau broker pakai nama lain, mis. "XAUUSDm" / "GOLD" / "XAUUSD.m"
TIMEFRAME = "M1"
...
TRADING_SESSION_START_UTC = 0
TRADING_SESSION_END_UTC = 23
